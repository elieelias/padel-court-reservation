...
import { Check, ChevronRight, Clock3, ListOrdered, LogOut, RefreshCw, UserRoundPlus, UsersRound, X } from "lucide-react";
              ...
              return (
                <article className="open-match-card" key={court.reservation_id}>
                  ...
                  <div>
                    ...
                    <p>{court.available_spots > 0 ? t("openCourts.spotsLeft", { count: court.available_spots }) : t("openCourts.full")}</p>
                  </div>
